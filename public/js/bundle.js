...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2FyYWRhZ3NlcmhhdCIsImEiOiJja3RiaWFramEwMnp0MnhvNTlzYjhqcnp6In0.WuItsC_E3QdhtPmuDZkjcA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>G\xFCn ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include current location
...
module.exports = {
  "_args": [
    [
      "axios@0.21.4",
      "C:\\Users\\serha\\OneDrive\\Masaüstü\\Project\\kamp-tur"
    ]
  ],
  "_from": "axios@0.21.4",
  "_id": "axios@0.21.4",
  ...
  "_spec": "0.21.4",
  "_where": "C:\\Users\\serha\\OneDrive\\Masaüstü\\Project\\kamp-tur",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Giriş Başarılı!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Çıkış yaprken hata çıktı. Lütfen tekrar deneyiniz!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "G\xFCncelleme ba\u015Far\u0131yla ger\xE7ekle\u015Fti!");
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JYmDlHz7eUSDF0l7WtjrHsVXHn7mUZEbC0vMvuLRzxwTxA1hXZAyfbpTiACdxAVJqV0LQ42JdKuK67BUXsiwk9X00R0u53OLQ');
            _context.prev = 1;
            _context.next = 4;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Kayıt Başarıyla Oluşturuldu!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
if (alertMessage) (0, _alerts.showAlert)('success', alertMessage, 8);
